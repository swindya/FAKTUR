    ...
    <td width="500" valign="top"><p>&nbsp;</p>
        ...
        <tr>
          <td style="margin-left: 23px;" width="100%"; >
		    ...
		    <h3 class="titlehdr">Login Users Aplikasi Faktur Pajak
			</h3> 
			<br>
          </td>
        </tr>
...
?>
        ...
        <table bgcolor="FFD06C" style="text-align: left; margin-left: auto; margin-right: auto; height: 60px;" width="400px" border="0" cellpadding="4" cellspacing="4">
          <tr> 
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr> 
            <td width="40%" style="padding-left: auto; text-align: left; font-size: 12;">&nbsp&nbsp&nbsp Username / Email</td>
            <td width="60%" style="padding-left: auto; text-align: left; font-size: 12;">&nbsp&nbsp<input name="username" type="text" class="required" id="txtbox" size="22" maxlength="36"></td>
          </tr>
          <tr> 
            <td style="padding-left: auto; text-align: left; font-size: 12;">&nbsp&nbsp&nbsp Password</td>
            <td style="padding-left: auto; text-align: left; font-size: 12;">&nbsp&nbsp<input name="passwd" type="password" class="required password" id="txtbox" size="22" maxlength="36"></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2" style="padding-left: auto; text-align: center; font-size: 12;"> <div align="center"> 
                <p> 
