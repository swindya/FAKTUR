...
$sql0 = "SELECT * FROM fakturpajak WHERE (MONTH(tglinvoice)=" . $bulanku . " AND YEAR(tglinvoice)=" . $tahunku . ") ORDER BY ID ASC;";
$jmlr0 = 0;
...
?>
		...
		<table style="margin-left: 0; margin-right: auto;" width="680px" border="0" cellspacing="0" cellpadding="0">
			<tr height="35px"> 
				<td style="padding-left: auto; text-align: center; font-size: 15;"><P><font face="arial" color="black" ><b>
					DOKUMEN TERTENTU YANG KEDUDUKANNYA DIPERSAMAKAN DENGAN FAKTUR PAJAK</b></font></P>
				</td>
			</tr>
		<table style="margin-left: 0; margin-right: auto; " width="680px" border="1" cellspacing="0" cellpadding="0">
			<tr height="22px" style="border: 1px solid black;"> 
				<td colspan="4" style="padding-left: 5pt; font-size: 12;"><font face="arial" color="black">Kode dan Nomor Seri DTFP :<span style="padding-left:80px"><b><?php print $nofakturku;?></b></font></td>
			</tr>
			<tr height="22px" style="border: 1px solid black;"> 
				<td colspan="4" style="padding-left: 5pt; font-size: 12;"><font face="arial" color="black">PENGUSAHA KENA PAJAK</font></td>
			</tr>
			<tr height="110px" style="border: 1px solid black;"> 
				...
				<tbody>
					<tr height="22">
						...
						<td style="padding-left: auto; font-size: 12;" width="10px">
			...
			<tr height="20px" style="border: 1px solid black;"> 
				<td colspan="4" style="">
				<table style="height: 20px; margin-left: 0; margin-right: auto;" border="0" cellspacing="0" cellpadding="0" width="680px">
				<tbody>
					<tr height="22">
						<td colspan="4" style="padding-left: 5pt; align: left; font-size: 12;">
			...
			<tr height="80px" style="border: 1px solid black;"> 
				<td colspan="4" style="">
				<table style="height: 88px; margin-left: 0; margin-right: auto;" border="0" cellspacing="0" cellpadding="0" width="680px">
				<tbody>
					<tr height="22">
					...
					<tr height="22">
						...
						<td style="padding-left: auto; font-size: 12;" width="500px">
							...
							<span style="padding-left:100"></span></font>
						</td>
					</tr>
				</tbody>
				</table>
			...
			<tr height="40px" style="border: 1px solid black;"> 
				...
				<td width="340px" style="border: 1px solid black;" valign="middle" style="text-align: center; ">
					<DIV align="center">
					<table style="width: 200px; height: 30px; margin-left: auto; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
				...
				<td width="100px" style="border: 1px solid black;" valign="middle" style="text-align: center; ">
					<DIV align="center">
					<table style="width: 100px; height: 30px; margin-left: auto; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td style="padding-left: auto; text-align: center; font-size: 12; border-collapse:collapse;">
								<p><font face="arial" color="black">Jumlah Satuan Barang (Apabila Ada)</font></p>
							</td>
						</tr>
					</table>
					</DIV>
				</td>
				<td width="200px" style="border: 1px solid black;" valign="middle" style="text-align: center; ">
					<DIV align="center">
					<table style="width: 160px; height: 30px; margin-left: auto; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td style="padding-left: auto; text-align: center; font-size: 12;">
			...
			<tr height="180px" style="border: 1px solid black;"> 
				<td width="40px" valign="middle" style="border: 1px solid black; padding-left: 0pt; text-align: center; ">
				</td>
				<td width="340px" valign="middle" style="border: 1px solid black; text-align: center; padding-top: 20pt; ">
					<table style="width: 270px; height: 80px; margin-left: auto; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
				...
				<td width="100px" valign="middle" style="border: 1px solid black; text-align: right; padding-top: 20pt; font-size: 12; ">
					<p><font face="arial" color="black" ><b><span style="padding-right:40"></span></b></font></p>
				</td>
				<td width="200px" valign="middle" style="border: 1px solid black; text-align: right; padding-top: 20pt; font-size: 12; ">
			...
			<tr height="25px" style="border: 1px solid black;"> 
				<td colspan="2" style="border: 1px solid black; padding-left: 10pt; text-align: left; font-size: 12;" width="380px">
					<p><font face="arial" color="black" ><strike>Harga Jual</strike>/Penggantian/<strike>Uang Muka/Terjamin</strike>**)</font></p>
				</td>
				<td style="border: 1px solid black; padding-left: auto; font-size: 12;" width="100px">
					<font face="arial" color="black"></font>
				</td>
				<td style="border: 1px solid black; padding-left: auto; padding-right: 30pt; text-align: right; font-size: 12;" width="200px">
					<p><font face="arial" color="black" ><b><?php print $safekpfee . ',-';?></b></font></p>
				</td>
			</tr>
			<tr height="25px" style="border: 1px solid black;"> 
				<td colspan="2" style="padding-left: 10pt; text-align: left; font-size: 12;" width="380px">
					<p><font face="arial" color="black">Dikurangi Potongan Harga</font></p>
				</td>
				<td style="border: 1px solid black; padding-left: auto; font-size: 12;" width="100px">
					<font face="arial" color="black"></font>
				</td>
				<td style="padding-left: 0pt; padding-right: 30pt; text-align: right; font-size: 12;" width="200px">
			...
			<tr height="25px" style="border: 1px solid black;"> 
				...
				<td style="border: 1px solid black; padding-left: 0pt; padding-right: 30pt; text-align: right; font-size: 12;" width="200px">
					<p><font face="arial" color="black" ><b></b></font></p>
				</td>
			</tr>
			<tr height="25px" style="border: 1px solid black;"> 
			...
			<tr height="190px" style="border: 1px solid black;"> 
				<td colspan="4" width="680px" valign="middle" style="padding-left: 0pt; text-align: left; ">
					<DIV align="center">
