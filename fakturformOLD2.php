...
$tglinvday = date("d", strtotime($mytglinvoice));
$tglinvbulan = $bulan[date("m", strtotime($mytglinvoice))-1];
$tglinvtahun = date("Y", strtotime($mytglinvoice));
?>
		...
		<table bgcolor="#CCEEFF" style="height: 850px; margin-left: auto; margin-right: auto;" width="850px" border="1" cellspacing="0" cellpadding="0">
			<tr height="30px"> 
				<td colspan="3" style="padding-left: 14pt; font-size: 11;"><font face="arial" color="black" >
					<small>Kode dan Nomor Seri Faktur Pajak :</small><span style="padding-left:70"><small><input style="type="text" name="nofaktur" id="nofaktur" size="25" value="<?php print $mynofaktur;?>"></small>
				</font></td>
			</tr>
			<tr height="30px"> 
				<td colspan="3" style="padding-left: 14pt; font-size: 12;"><font face="arial" color="black"><small>PENGUSAHA KENA PAJAK</small></font></td>
			</tr>
			<tr height="140px"> 
				<td colspan="3">
			...
			<tr height="240px" > 
				...
				<td width="360px" valign="middle" style="text-align: right; padding-top: 20pt; font-size: 12;">
					...
					<small><input style="text-align: right" type="text" name="hargajual" id="hargajual" size="16" value="<?php print number_format($mytotal,2) . ',-';?>"></small>
					</span></b></font></p>
				</td>
			</tr>
			<tr height="30px"> 
					...
					<table style="width: 850px; height: 22px; margin-left: 0; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="padding-left: 0pt; padding-right: 60pt; text-align: right;  font-size: 11;" width="40%">
								...
								<span style="padding-left:0;"><small><input style="text-align: right" type="text" name="hargaganti" id="hargaganti" size="16" value="<?php print number_format($mytotal,2) . ',-';?>"></small>
								</b></font></p>
							</td>
						</tr>
					</table>
					...
					<table style="width: 850px; height: 22px; margin-left: 0; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="padding-left: 0pt; padding-right: 60pt; text-align: right; font-size: 12;" width="40%">
								<p><font face="arial" color="black" ><b>
								<span style="padding-left:0;"><small><input style="text-align: right" type="text" name="potharga" id="potharga" size="16"></small>
								</b></font></p>
							</td>
						</tr>
					</table>
					...
					<table style="width: 850px; height: 22px; margin-left: 0; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="padding-left: 0pt; padding-right: 60pt; text-align: right" width="40%">
								<p><font face="arial" color="black" ><b>
								<span style="padding-left:0;"><small><input style="text-align: right" type="text" name="uangmuka" id="uangmuka" size="16"></small>
								</b></font></p>
							</td>
						</tr>
					</table>
					...
					<table style="width: 850px; height: 22px; margin-left: 0; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="padding-left: 0pt; padding-right: 60pt; text-align: right" width="50%">
								<p><font face="arial" color="black" ><b>
								<span style="padding-left:0;"><small><input style="text-align: right" type="text" name="dasarkenapajak" id="dasarkenapajak" size="16" value="<?php print number_format($mytotal,2) . ',-';?>"></small>
								</b></font></p>
							</td>
						</tr>
					</table>
				...
				<td colspan="3" width="850px" valign="middle" style="padding-left: 0pt; text-align: left">
					...
					<table style="width: 850px; height: 22px; margin-left: 0; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td style="padding-left: 0pt; padding-right: 60pt; text-align: right" width="40%">
								<p><font face="arial" color="black" ><b>
								<span style="padding-left:0;"><small><input style="text-align: right" type="text" name="ppn" id="ppn" size="16" value="<?php print number_format($mytotal*0.1,2) . ',-';?>"></small>
								</b></font></p>
							</td>
						</tr>
					</table>
			...
			<tr height="180px"> 
				<td colspan="3" width="850px" valign="middle" style="padding-left: 0pt; text-align: left">
					...
					<table style="width: 850px; margin-left: auto; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr height="180px">
							<td style="padding-left: 14pt; text-align: left; font-size: 12;" width="45%">
								...
								<table style="width: 100%; height: 150px; margin-left: auto; margin-top: 30; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
									...
									<tr height="140px" valign="bottom">
										<td style="padding-left: 0pt; text-align: center; font-size: 11;" width="22%">
											...
											<span style="padding-left:0; line-height:10%;"><small>Nama :</small><small><input style="text-align: right" type="text" name="namattd" id="namattd" size="20" value="<?php print $mynamattd;?>">
											</font></p>
											<p><font face="arial" color="black" >
											<span style="padding-left:0;"><small>Jabatan :</small><small><input style="text-align: right" type="text" name="jabatan" id="jabatan" size="20" value="<?php print $myjabatanttd;?>"></small>
											</font></p>
										</td>
									</tr>
								</table>
