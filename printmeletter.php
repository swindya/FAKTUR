...
$sql1 = "SELECT * FROM fakturpajak WHERE ID=" . $idku . ";";
$jmlr1 = 0;
...
if ($jmlr1 > 0) {
	...
	while ($row = mysqli_fetch_array ($res1, MYSQLI_ASSOC)) {
		...
		$tglpkp = $row['npwpbp'];
		$nppkpku = $row['nppkp'];
		$safekeepingfeeku = $row['safekeepingfee'];
		$safekeepingfeeku = number_format($safekeepingfeeku,0);
		$safekeepingfeeku = str_replace(',','.',$safekeepingfeeku);
		$pajakku = $row['ppn'];
		$totali = $row['total'];
		$totalku = round($totali,0);
		$feeku = $totalku * 100 / 110;
		$ppnku = round($feeku * 0.11,0);
		...
		$pajakku = number_format($pajakku,0);
		$pajakku = str_replace(',','.',$pajakku);
...
?>
		...
		<table style="margin-left: 0; margin-right: auto; " width="680px" border="1" cellspacing="0" cellpadding="0">
			...
			<tr height="40px" style="border: 1px solid black;"> 
				...
				<td width="340" style="border: 1px solid black;" valign="middle" style="text-align: center; ">
					<DIV align="center">
					<table style="width: 270px; height: 30px; margin-left: auto; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
						<tr>
				...
				<td width="200" style="border: 1px solid black;" valign="middle" style="text-align: center; ">
					<DIV align="center">
			...
			<tr height="180px" style="border: 1px solid black;"> 
				...
				<td width="270px" valign="middle" style="border: 1px solid black; text-align: right; padding-top: 20pt; font-size: 12; ">
					...
					<p><font face="arial" color="black" ><b><span style="padding-right:40"><?php print $safekeepingfeeku . ',-';?></span></b></font></p>
					</td>
			</tr>
			<tr height="25px" style="border: 1px solid black;"> 
				...
				<td style="border: 1px solid black; padding-left: auto; padding-right: 30pt; text-align: right; font-size: 12;" width="200px">
					<p><font face="arial" color="black" ><b><?php print $safekeepingfeeku . ',-';?></b></font></p>
				</td>
			</tr>
			<tr height="25px" style="border: 1px solid black;"> 
				<td colspan="2" style="border: 1px solid black; padding-left: 10pt; text-align: left; font-size: 12;" width="380px">
			...
			<tr height="25px" style="border: 1px solid black;"> 
				<td colspan="2" style="border: 1px solid black; padding-left: 10pt; text-align: left; font-size: 12;" width="380px">
					<p><font face="arial" color="black">PPN = 11% X Dasar Pengenaan Pajak</font></p>
				</td>
				<td style="border: 1px solid black; padding-left: auto; font-size: 12;" width="100px">
					<font face="arial" color="black"></font>
				</td>
				<td style="border: 1px solid black; padding-left: 0pt; padding-right: 30pt; text-align: right; font-size: 12;" width="200px">
					<p><font face="arial" color="black" ><b><?php print $pajakku . ',-';?></b></font></p>
				</td>
			</tr>
								...
								<table style="width: 100%; height: 160px; margin-left: auto; margin-top: 20; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
									<tr height="20px" valign="top">
										<td style="padding-left: 0pt; padding-top: 10pt; text-align: center; font-size: 12;" width="22%">
											<p><font face="arial" color="black" ><?php print $kotattdku . " , " . $tglfday . " " . $tglfbulan . " " . $tglftahun;?></font></p>
										</td>
									</tr>
