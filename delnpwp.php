...
$npwpidku = $_GET['npwpid'];
$statdelnpwp = $_SESSION["delnpwp"];
...
if ($statdelnpwp == 1) {
	$tahuniki = date("Y");
	$sql0 = "SELECT * FROM npwp WHERE ID=" . $npwpidku . ";";
	$jmlr0 = 0;
...
/* determine number of rows result set */
	...
	if ($jmlr0 > 0) {
		$sql2 = "DELETE FROM npwp WHERE ID=" . $npwpidku . ";";
		$res2 = mysqli_query($link, $sql2);
		echo "SUKSES !! Data berhasil dihapus.";
	}
	else {
		echo "GAGAL ! Data tidak berhasil dihapus. Periksa kembali data anda.";
	}
}
$_SESSION["delnpwp"] = 0;
...
<a href="javascript:window.opener.location.reload();"></a>
