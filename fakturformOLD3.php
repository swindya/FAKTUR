...
if ($jmlr > 0) {
	...
	while ($row = mysqli_fetch_array ($res, MYSQLI_ASSOC)) {
		...
		$myfee = round($mytotal * 100 / 110,0);
		$myppn = round($myfee * 0.1,0);
...
<table style="text-align: center; margin-left: auto; margin-right: auto;" width="850px" border="0" cellspacing="0" cellpadding="0">
	<tr height="40px">
		<td style="padding-left: auto; padding-bottom: auto; text-align: center;">
			<big><big><big><big><b>FAKTUR PAJAK</b></big></big></big></big>
		</td>
	</tr>
		...
		<table bgcolor="#CCEEFF" style="height: 850px; margin-left: auto; margin-right: auto;" width="850px" border="1" cellspacing="0" cellpadding="0">
			<tr height="30px"> 
				<td colspan="3" style="padding-left: 14pt; font-size: 11;"><font face="arial" color="black" >
					<small>Kode dan Nomor Seri Faktur Pajak :</small><span style="padding-left:75"><small><input style="type="text" name="nofaktur" id="nofaktur" size="25" value="<?php print $mynofaktur;?>"></small>
				</font></td>
			</tr>
			<tr height="30px"> 
								...
								<table style="width: 100%; height: 150px; margin-left: auto; margin-top: 30; margin-right: auto;" border="0" cellspacing="0" cellpadding="0">
									<tr height="20px" valign="top">
										<td style="padding-left: 0pt; padding-top: 10pt; text-align: center; font-size: 11;" width="22%">
											<p>
											<small>
											<input style="font-size: 10pt; text-align: right" type="text" name="kota" id="kota" size="12" value="Jakarta">
											, tgl
