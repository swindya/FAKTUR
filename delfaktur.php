...
$fakturidku = $_POST['faktid'];
$statdelfaktur = $_SESSION["delfaktur"];
...
$tahuniki = date("Y");
$sql0 = "SELECT * FROM fakturpajak WHERE ID=" . $fakturidku . ";";
$jmlr0 = 0;
...
if ($jmlr0 > 0) {
	$sql2 = "DELETE FROM fakturpajak WHERE ID=" . $fakturidku . ";";
	$res2 = mysqli_query($link, $sql2);
	echo "Sukses !! Data berhasil dihapus.";
}
else {
	echo "Data tidak berhasil dihapus. Periksa kembali data anda.";
}
