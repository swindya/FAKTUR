...
<a href="login.php"></a>
<table style="width: 450px; text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr height="50px">
	<td style="width: 450px; text-align: right;"><a href="javascript:void(0)" class="easyui-linkbutton" id="logout" name="logout" onclick="logoutme();">Logout</a></td>
	</tr>
  </tbody>
</table>

<table bgcolor="FFD06C" style="width: 450px; text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr height="10px">
		<td colspan="2" style="width: 450px; text-align: center;"> </td>
	</tr>
    <tr height="50px" valign="top">
		<td colspan="2" style="width: 450px; text-align: left; padding-left: 10pt; padding-top: 5pt;">
			<font face="arial" color="blue" size="2"><h2>Nama Perusahaan & NPWP</h2></font>
		</td>
	</tr>
	<form id="carinpwp" name="carinpwp" method="post" target=_blank action="npwplist.php">
	<tr style="height: 30px;">
		<td style="width: 150px; text-align: left; padding-left: 10pt;">Nama Perusahaan</td>
		<td style="width: 300px; text-align: left; padding-left: 5pt"> 
...
?>
	...
	<tr height="60px">
		<td  colspan="2" style="width: 450px; text-align: center;">
		    <div style="text-align:center ;padding:0px">
				<a href="javascript:void(0)" class="button blue bigrounded" target=_blank onclick="subcarinpwp();">Cari/Filter</a>
			</div>
		</td>
	</tr>
	</form>
	<tr height="90px">
				...
				<table style="height: 90px; margin-left: auto; margin-right: auto;" border="0" cellspacing="0" cellpadding="0" width="450px">
				<tbody>
					<tr height="60px" valign="top">
						<td colspan="3" style="padding-left: 10pt; text-align: left; font-size: 12;" width="120px">
						<font face="arial" color="black"><small><p>Upload File & Replace Data</p><br>
...
<table style="background-color: rgb(209, 226, 255);width: 450px; text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr height="10px">
    ...
    <tr height="50px" valign="top">
	<td  colspan="2" style="width: 150px; text-align: left; padding-left: 10pt; padding-top: 5px;">
		<font face="arial" color="blue" size="2"><h2>Cari Data Faktur</h2></font></td>
	</tr>
...
?>
	...
	<tr style="height: 30px;">
		<td style="width: 150px; text-align: left; padding-left: 10pt">Periode</td>
		<td style="width: 300px; text-align: left; padding-left: 5pt"> 
			<font face="arial" color="green" size="2">
...
?>
	...
	<tr height="60px">
		<td colspan="2" style="width: 450px; text-align: left;">
			...
			<a href="javascript:void(0)" class="button orange bigrounded" target=_blank onclick="subcarifaktur();">Cari/Filter</a>
	...
	<tr height="90px">
		...
		<tbody>
			<tr height="60px" valign="top">
				<td colspan="3" style="padding-left: 10pt; text-align: left; font-size: 12;" width="120px">
					<font face="arial" color="black"><small><p>Upload File</p><br>
